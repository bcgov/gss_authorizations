...
sys.path.append(r'\\spatialfiles.bcgov\work\srm\nel\Local\Geomatics\Workarea\csostad\GitHubAutoAST\gss_authorizations\autoast\auto_ast_v3_Breville_folium_maps_B_BCGW_Replace')
...
def main():
    ...
    arcpy.AddMessage("======================================================================")
    arcpy.AddMessage("Checking BCGW Credentials - may take a minute to process...TEST!")



#NOTE - Commented out the following code block as it is not needed for the BCGW connection
    ...
    print(f" arcgis workspace is set to {arcpy.env.workspace}")
    
    
    
    #Check RAAD connection
    print("checking RAAD connection")
