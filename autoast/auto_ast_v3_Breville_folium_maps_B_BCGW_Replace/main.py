...
excel_file = 'gr_2025_26_5_jobs.xlsx'
...
if __name__ == '__main__':
    ...
    print("Main: Setting up BCGW")
    logger.info("Main: Setting up BCGW")
    secrets = setup_bcgw(logger)

    # Create the path for the queuefile
    print("Main: Creating queuefile path")
    logger.info("Main: Creating queuefile path")
    ...
    print("Main: Creating AST Factory")
    logger.info("Main: Creating AST Factory")
    ...
    print("Main: Loading Jobs")
    logger.info("Main: Loading Jobs") 
    jobs = ast.load_jobs()
    
    print("Main: Batch AST")
    logger.info("Main: Batch AST")
    ast.batch_ast()
    ...
    print("Main: Re Running Batch AST")
    logger.info("Main: Re Running Batch AST")
    ast.batch_ast()
